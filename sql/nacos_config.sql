...
INSERT INTO `his_config_info` VALUES (0, 68, 'oss.yml', 'DEFAULT_GROUP', '', '#阿里云OSS参数\r\nalibaba:\r\n  cloud:\r\n    access-key: LTAI4GFKKZSC4w9gCLfTcAZY\r\n    secret-key: Vc8yXYHrVs9ioJ4AUNKFZZ4SykCTfA\r\n    bucket-name: alphahub-test-bucket\r\n    url-prefix: https://${alibaba.cloud.bucket-name}.${alibaba.cloud.oss.endpoint}/\r\n    oss:\r\n      endpoint: oss-cn-shanghai.aliyuncs.com', 'efe9531504ac88136fd09a8ce3e434ac', '2021-02-13 22:32:50', '2021-02-13 22:32:50', NULL, '192.168.2.1', 'I', 'cc925dd8-8be2-4be5-b3f1-8a43ea0e6827');
INSERT INTO `his_config_info` VALUES (58, 69, 'oss.yml', 'DEFAULT_GROUP', '', '#阿里云OSS参数\r\nalibaba:\r\n  cloud:\r\n    access-key: LTAI4GFKKZSC4w9gCLfTcAZY\r\n    secret-key: Vc8yXYHrVs9ioJ4AUNKFZZ4SykCTfA\r\n    bucket-name: alphahub-test-bucket\r\n    url-prefix: https://${alibaba.cloud.bucket-name}.${alibaba.cloud.oss.endpoint}/\r\n    oss:\r\n      endpoint: oss-cn-shanghai.aliyuncs.com', 'efe9531504ac88136fd09a8ce3e434ac', '2021-02-14 20:04:27', '2021-02-14 20:04:28', NULL, '192.168.2.1', 'U', 'cc925dd8-8be2-4be5-b3f1-8a43ea0e6827');
INSERT INTO `his_config_info` VALUES (58, 70, 'oss.yml', 'DEFAULT_GROUP', '', '#阿里云OSS参数\nalibaba:\n  cloud:\n    access-key: LTAI4GFKKZSC4w9gCLfTcAZY\n    secret-key: Vc8yXYHrVs9ioJ4AUNKFZZ4SykCTfA\n    bucket-name: alphahub-test-bucket\n    url-prefix: https://${alibaba.cloud.bucket-name}.${alibaba.cloud.oss.endpoint}\n    oss:\n      endpoint: oss-cn-shanghai.aliyuncs.com', '835dfae845d3d5b5a1defee69307ba54', '2021-02-14 20:05:59', '2021-02-14 20:06:00', NULL, '192.168.2.1', 'U', 'cc925dd8-8be2-4be5-b3f1-8a43ea0e6827');
INSERT INTO `his_config_info` VALUES (58, 71, 'oss.yml', 'DEFAULT_GROUP', '', '#阿里云OSS参数\nalibaba:\n  cloud:\n    access-key: LTAI4GFKKZSC4w9gCLfTcAZY\n    secret-key: Vc8yXYHrVs9ioJ4AUNKFZZ4SykCTfA\n    bucket-name: alphahub-test-bucket\n    host-prefix: https://${alibaba.cloud.bucket-name}.${alibaba.cloud.oss.endpoint}\n    oss:\n      endpoint: oss-cn-shanghai.aliyuncs.com', 'd9eea02d0aaa9672e7be6656cd19c28f', '2021-02-14 20:08:14', '2021-02-14 20:08:15', NULL, '192.168.2.1', 'U', 'cc925dd8-8be2-4be5-b3f1-8a43ea0e6827');
INSERT INTO `his_config_info` VALUES (58, 72, 'oss.yml', 'DEFAULT_GROUP', '', '#阿里云OSS参数\nalibaba:\n  cloud:\n    access-key: LTAI4GFKKZSC4w9gCLfTcAZY\n    secret-key: Vc8yXYHrVs9ioJ4AUNKFZZ4SykCTfA\n    bucket-name: alphahub-test-bucket\n    host-prefix: https://${alibaba.cloud.bucket-name}.${alibaba.cloud.oss.endpoint}/\n    oss:\n      endpoint: oss-cn-shanghai.aliyuncs.com', '05ea378c655bebfa1c1b30f7486cd711', '2021-02-14 21:44:06', '2021-02-14 21:44:07', NULL, '192.168.2.1', 'U', 'cc925dd8-8be2-4be5-b3f1-8a43ea0e6827');
